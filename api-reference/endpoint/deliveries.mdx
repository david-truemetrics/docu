...
description: "This endpoint provides access to insights about your historical deliveries. Here you can find stop and parking times and estimated distances from parking place to the customer. To access a delivery, just use the delivery id as path parameter and get your results."
---
