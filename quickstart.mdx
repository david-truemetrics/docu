...
<AccordionGroup>
  ...
  <Accordion icon="github" title="Integrate via Maven">
    To ensure a smooth integration in your app, we provide you a maven repository. Just take a look into the [documentation](https://docu.truemetrics.cloud/functions#setup-and-maven-repository) on how to integrate the maven repository
  </Accordion>
